  ...
  const stats = useMemo(() => {
    try {
      ...
      return {
        ...
        percentAceptado: mainTotalGlosado > 0 ? Math.min(100, Math.max(0, Math.round((totalAceptadoValue / mainTotalGlosado) * 100))) : 0,
        percentRegistrado: totalPotentialGlosado > 0 ? Math.min(100, Math.max(0, Math.round((totalRegistradoInternoValue / totalPotentialGlosado) * 100))) : 0,
      ...
      >
        ...
        <div style={{ padding: '0 1rem', marginBottom: '2rem' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1.5rem' }}>
            ...
            <h2 style={{ fontSize: '1.1rem', fontWeight: 900, color: '#00f2fe', letterSpacing: '0.05em' }}>V10.5 - HOTFIX</h2>
          </div>
        </div>
